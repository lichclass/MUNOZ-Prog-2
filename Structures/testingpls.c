...
typedef struct{
    studList *list; // will dynamically allocate 3 elements - CS,IS,IT
}studRecordV2;

studRecordV1 separatePls(studList myList){
    
    int i;
    studRecordV1 separated;
...
void main(){
    ...
    studRecordV1 separated = separatePls(myList);
